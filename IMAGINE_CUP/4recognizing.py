        ...
        if confidence > conf:
            ...
            with open('student1.csv', 'r') as csvFile:
                ...
                if name in listString:
                    ...
                    print(Roll_Number)
                    now = datetime.now()
                    with open('attendance.csv', mode='w') as employee_file:
                        employee_writer = csv.writer(employee_file, quoting=csv.QUOTE_MINIMAL,
                                                  delimiter=',')

                        employee_writer.writerow([name,Roll_Number,now])
